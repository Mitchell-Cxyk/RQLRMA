function Q = imreadqtodouble(varargin)
...
%Now trans the unit8 to double.
Nu=im2double(A);
N = size(Nu, 3); % Find out how many image components are in the array A.

if N == 3 % The image is RGB.
    Q = quaternion(Nu(:,:,1), Nu(:,:,2), Nu(:,:,3));
else
