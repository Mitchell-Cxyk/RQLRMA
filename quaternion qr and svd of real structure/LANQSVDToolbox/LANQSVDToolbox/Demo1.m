%% Section 4.1: Example 1: Principal Component Analysis--Case 1
% in paper:
...
for m=1000:100:1000%3200 % for the first case
    n=m*0.1;
    mySeed = 20;rng(mySeed);
    A=rand(m,4*n);
%     A=randn(m,4*n); 
    [A0,A1,A2,A3]=A2A0123(A); A=[A0 A2 A1 A3];
    %% LANQSVD
    k=0.1*n;
    t0=cputime;
...
set(axes1,'FontSize',14,'FontWeight','bold','XTick',[1,6 11 16 21 26 31],...
    'XTickLabel',{'200','700','1200','1700','2200','2700','3200'},'YMinorTick','on',...
    'YScale','log');
% Create legend
